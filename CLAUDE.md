...
> **สถานะจริง ณ 2026-08-11: CI deploy ทำงานแล้ว** — secret ครบทั้ง `ENV_FILE` และ `FIREBASE_SERVICE_ACCOUNT` (ตั้ง 2026-08-10) และ `deploy.yml` รันสำเร็จแล้ว (run 31484648125)
> merge เข้า `main` = deploy prod อัตโนมัติ
