                  ...
                  <Fragment key={req.id}>
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        ...
                        {/* ประเภทการจ้าง — รอบจ่ายไม่โชว์ในแถว (กรองได้จาก chip "รอบจ่าย" ด้านบน) */}
                        <p className="mt-0.5 text-[11px] font-bold text-neutral-400">{req.employmentType || 'Permanent'}</p>
                      </td>
                      <td className="px-4 py-3">
